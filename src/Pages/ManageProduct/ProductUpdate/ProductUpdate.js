...
const ProductUpdate = () => {
    ...
    const handleDelivered = ()=> {
        ...
        const subQty = parseInt(product.quantity) - 1;
        const newQty={quantity:subQty, ...rest};
    ...
    const handleRestock=e=>{
        e.preventDefault();
        const { quantity, ...rest } = product;
        const qty=parseInt(e.target.restock.value);
        ...
        fetch(url, {
            ...
            body : JSON.stringify(restockQty)
        })
        .then(res=>res.json())
        .then(data=>{
            console.log(data);
    ...
    return (
        <div className='container mx-auto text-lg'>
            ...
            <form onSubmit={handleRestock} className=' mx-auto w-96 h-48 shadow-lg px-8 md:mx-96 mt-10'>
